            ...
            <tr>
                ...
                <td class="dashed-border-right">
                    <table class="header-table">
                        <tr>
                            ...
                            <td style="text-align:right; vertical-align:middle;">
                                ...
                                <div style="font-size:14px; font-weight:bold;">Office Copy</div>
                    ...
                    <table class="footer-table">
                        <tr>
                            <td>
                                <div class="signature-line"></div>Office Signature
                            </td>
                            <td>
                                <div class="signature-line"></div>Employee Signature
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td>
                    ...
                    <table class="details-table">
                        <tr>
                            <th>Name</th>
                            <td>{{ $data['employee_name'] ?? 'N/A' }} ({{ $data['employee_id'] ?? 'N/A' }})</td>
                        </tr>
                        <tr>
                            <th>Employee ID</th>
                            <td>{{ $data['employee_id'] ?? 'N/A' }}</td>
